...
### What's the trend of the banking industry based on the regulator's information?
...
```
At State level, there's a clear gap between those state with high number of branches and accounts per 10,000 inhabitants, such as Nuevo León, Jalisco and Mexico City, and those states with low branches and accounts penetration, such as Chiapas, Oaxaca and Guerrero. 
