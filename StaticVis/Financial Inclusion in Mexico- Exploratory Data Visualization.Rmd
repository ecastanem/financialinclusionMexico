...
sub<-MEX_map_mun_cred %>% ggplot()+
  geom_histogram(aes(x=HHI,color=`Concentration Group`),binwidth = 1000, fill = "grey", color = "black",show.legend = TRUE)+
  theme_minimal()+
  scale_x_continuous(label=comma)+
  labs(title='HHI Distribution')+
  theme(panel.grid.major = element_line(color='transparent'), panel.grid.minor = element_blank(), panel.background = element_blank())

vp<-viewport(width =unit(3,'inches'), height = unit(2.5,'inches'),x=.75,y=.7)
