...
Moreover, 60% of the deposits are hold by four banks, whereas the remaining 40% is hold by more than 40, which indicates that the industry follows an oligopoly structure. Besides, these four banks hold only 35% of the branches in the country, which might be because of the geographical distribution of the customers. 
...
There's a high concentration of the branches at State level, the same five banks hold at least 50% of the branches in each state.These indicates that the trap on the growing of the financial inclusion in the country might be associated to an oligopoly issue. It would be interesting to compare the number of branches with the percentage of accounts and deposits by state to validate this hypothesis. 
